...
class OurPrincipleController extends Controller
{
    ...
    public function store(StorePrincipleRequest $request)
    {
        ...
        return redirect()->route('admin.principles.index',)->with('success', 'Principle Section added successfully!');
    }
    ...
    // {
    //     OurPrinciple::destroy($id);
    //     return redirect()->route('admin.principles.index')->with('success', 'Deleted Successfully');
    // }
