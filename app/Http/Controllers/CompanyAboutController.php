...
class CompanyAboutController extends Controller
{
    ...
    public function store(StoreAboutRequest $request)
    {
        ...
        return redirect()->route('admin.abouts.index',)->with('success', 'About section added successfully!');;
    }
    ...
    // {
    //     CompanyAbout::destroy($id);
    //     return redirect()->route('admin.abouts.index')->with('success', 'Deleted successfully!');
    // }
